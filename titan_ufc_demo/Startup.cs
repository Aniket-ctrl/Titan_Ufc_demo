...
namespace titan_ufc_demo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<Applicationdb_context>(x => x.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=UFC_Demo;Trusted_Connection=True;MultipleActiveResultSets=true;Column Encryption Setting=enabled"));
